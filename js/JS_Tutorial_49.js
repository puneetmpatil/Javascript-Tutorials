...
! \w:  
* This is the "word character" class that represents the regex range [A-Za-z0-9_], and it will match a single uppercase character, lower-case character, digit, or underscore

! \d: 
* This is the "digit character" class represents the regex range [0-9], and it will match the single-digit character

! \s: 
* This is the "whitespace character" class that represents the regex range, matching a single space, carriage return, tab, line break, form feed, or vertical tab
...
! \W: 
* the "non-word character" class represents the regex range [^A-Za-z0-9_], matching any character that is not included in the range represented by \w

! \D: 
* the "non-digit character" class represents the regex range [^0-9], matching any character that is not included in the range represented by \d
...
// Character classes
let regex = /\war/          // \w - word character - _/alphabet/number
...
regex = /\ska number/     // \s matches whitespace character
regex = /\s+ka number/     // \s+ matches one or more than one whitespace character
regex = /\Ska number/     // \S matches non whitespace character
regex = /\S+ka number/     // \S+ matches one or more than one non whitespace character
...
const str = 'harh%7rd1r4r5y%%$@bhai hyrryika number 89999harry9999'
